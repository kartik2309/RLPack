...
class GaussianMixture(pytorch_distributions.MixtureSameFamily, ABC):
    """
    This class implements the Gaussian Mixture distribution. This class inherits from PyTorch's
