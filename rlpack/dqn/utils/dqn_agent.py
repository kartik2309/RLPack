...
class DqnAgent(Agent):
    """
    The DqnAgent is the base class for DQN methods. This class implements basic methods and
    abstract functions for DQN variants.
    """
    ...
    def __init__(
        ...
        **Notes**
        ...
        self.tau = float(tau)
        # CHeck sanity and validity for `apply_norm_to`.
        ...
        self.step_counter = 0
        ## The instance of @ref rlpack._C.replay_buffer.ReplayBuffer used for Replay buffer. @I{# noqa: E266}
    ...
    @pytorch.no_grad()
    def policy(
        self, state_current: Union[np.ndarray, pytorch.Tensor, List[float]]
    ) -> np.ndarray:
        """
    ...
    def _load_random_experiences(
        ...
        @return List[pytorch.Tensor]: The list of tensors as [states_current, states_next, rewards, actions, dones,
            priorities, probabilities, weights, random_indices].
